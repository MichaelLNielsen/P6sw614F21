...
public enum EventType {
    HeatPumpOn(7.0), PowerPlugsDiningRoomOn(0.0), PowerPlugsAtticOn(0.0), PowerPlugsMasterBedroomOn(0.0), PowerPlugsBedroom2On(23.0), PowerPlugsBedroom3On(0.0),
    PowerPlugsBedroom4On(0.0), PowerClothesWasherOn(0.0), DishwasherOn(0.0), FirstFloorLightsOn(0.0), SecondFloorLightsOn(0.0), ClothesWasherOn(3.0), DryerOn(0.0),
